...
public class BookingResponseMapper {
    ...
    public BookingDetailResponse toDetail(Booking booking) {
        return BookingDetailResponse.builder()
                ...
                .currency(booking.getCurrency())
                .promotionCode(booking.getPromotionCode())
                .promotionBenefitScope(booking.getPromotionBenefitScope())
                .promotionDiscountAmount(booking.getPromotionDiscountAmount())
                .ticketPromotionDiscount(booking.getTicketPromotionDiscount())
                .concessionPromotionDiscount(booking.getConcessionPromotionDiscount())
