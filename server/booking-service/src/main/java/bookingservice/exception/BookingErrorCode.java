...
public enum BookingErrorCode implements BaseErrorCode {
        ...
        SEATS_ALREADY_TAKEN(2006, "The selected seats are already reserved or sold",
                        HttpStatus.CONFLICT),
        ...
        IDEMPOTENCY_KEY_REUSED_WITH_DIFFERENT_REQUEST(
                        2013, "IDEMPOTENCY_KEY_REUSED_WITH_DIFFERENT_REQUEST", HttpStatus.CONFLICT),
        INVENTORY_SERVICE_UNAVAILABLE(
                        2014, "INVENTORY_SERVICE_UNAVAILABLE", HttpStatus.SERVICE_UNAVAILABLE);
