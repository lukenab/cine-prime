                  ...
                  <tr key={r.ratingId} className="hover-row border-b transition-colors" style={{ borderColor: "var(--border-color)" }}>
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-2">
                        <button onClick={() => openEdit(r)} className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border hover:bg-blue-50 hover:border-blue-200 hover:text-blue-600 transition-colors" style={{ fontSize: "12px", color: "var(--text-sub)", borderColor: "var(--border-color)" }}>
                          <Pencil size={12} /> Edit
                        </button>
                        <button onClick={() => setDeleteTarget(r)} className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border hover:bg-rose-50 hover:border-rose-200 hover:text-rose-600 transition-colors" style={{ fontSize: "12px", color: "var(--text-sub)", borderColor: "var(--border-color)" }}>
